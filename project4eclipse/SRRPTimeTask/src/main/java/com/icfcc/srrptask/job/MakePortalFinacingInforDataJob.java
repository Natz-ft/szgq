...
public class MakePortalFinacingInforDataJob extends JobObkect {
	...
	public void execute(JobExecutionContext context) throws JobExecutionException {
		...
		try {
			...
			List<FinancingInfoQuery> res = null;
			res = financingInfoDetailService.generateLatest(Integer.parseInt(SynCount));
			financingInfoDetailService.saveLatest(res);
			executeResult = SRRPConstant.EXECUTSUCC;
			msg = "完成迁移门户融资需求查询列表的数据";
		} catch (Exception e) {
