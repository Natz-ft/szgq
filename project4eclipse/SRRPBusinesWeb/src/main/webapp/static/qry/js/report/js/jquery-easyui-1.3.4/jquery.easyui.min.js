...
_1d5._outerHeight(_1d3.height()-_1d4._outerHeight()+40);
}else{
_1d5.height("auto");
}
_1d3.css("height","");
...
_24a.panel("resize",{width:_252.width(),height:(_251=="auto")?"auto":_252.height()-_252.children("div.dialog-toolbar")._outerHeight()-_252.children("div.dialog-button")._outerHeight()-40});
if(opts.onResize){
