...
public class Investor implements Serializable {
   ...
   public void setCreateTimeStr(String createTimeStr) {
	...
	public String getOperationQualification3Dicname() {
		return RedisGetValue.getValueByCode(SRRPConstant.DD_RADIO, this.operationQualification3);
	}
	...
	public String getOrganizationalFormDicname() {
		return RedisGetValue.getValueByCode(SRRPConstant.DD_ORGFORM, this.organizationalForm);
	}
