...
public class InvestorSubaccount implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 402208737414299570L;
	...
	public int getInvestmentProjects() {
		return investmentProjects;
	}

	public void setInvestmentProjects(int investmentProjects) {
	...
	public int getImplementExitProject() {
		return implementExitProject;
	}

	public void setImplementExitProject(int implementExitProject) {
