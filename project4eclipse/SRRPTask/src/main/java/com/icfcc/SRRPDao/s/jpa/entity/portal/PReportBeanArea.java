 ...
 */
@Entity
@Table(name = "platform_portal_report_area")
public class PReportBeanArea implements Serializable, Comparable<PReportBeanArea> {
	...
	@Override
	public int compareTo(PReportBeanArea o) {
