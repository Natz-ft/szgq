...
public class PdfHelper {  
    ...
    public static com.icfcc.credit.platform.IText.ITextRenderer getNewRender(String path) throws DocumentException, IOException {  
    	   
    	com.icfcc.credit.platform.IText.ITextRenderer render = new com.icfcc.credit.platform.IText.ITextRenderer();  
