...
public class ITextRenderer {
    ...
    public void createPDF(OutputStream os, boolean finish, int initialPageNo) throws DocumentException {
        ...
        com.lowagie.text.Document doc = new com.lowagie.text.Document(new RectangleReadOnly(842F,595F));
        ...
        writePDF(pages, c, new RectangleReadOnly(842F,595F), doc, writer);
    ...
    private void writePDF(List pages, RenderingContext c, com.lowagie.text.Rectangle firstPageSize, com.lowagie.text.Document doc,
        ...
        _outputDevice.initializePage(writer.getDirectContent(), new RectangleReadOnly(842F,595F).getHeight());
        ...
        for (int i = 0; i < pageCount; i++) {
            ...
            if (i != pageCount - 1) {
                doc.setPageSize(new RectangleReadOnly(842F,595F));
                doc.newPage();
                _outputDevice.initializePage(writer.getDirectContent(), new RectangleReadOnly(842F,595F).getHeight());
            }
        }
