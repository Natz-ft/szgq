...
/**
 * 
* @ClassName: SystemRoleMenuDao
* @Description: TODO(权限菜单的增删改查接口)
* @author hugt
* @date 2017年9月14日 下午7:25:06
*
 */
public interface SystemRoleMenuDao extends PagingAndSortingRepository<PlatformRoleMenu, String>,
    JpaSpecificationExecutor<PlatformRoleMenu>
{
    /**
     * <根据菜单Id和角色Id删除按钮权限>
     * 
