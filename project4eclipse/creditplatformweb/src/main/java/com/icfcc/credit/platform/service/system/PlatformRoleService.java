...
import com.icfcc.credit.platform.jpa.repository.system.PlatformRoleDao;
...
public class PlatformRoleService
{
    ...
    public void InveInsertUserRoleRel(String userId, String roleId,String nicName)
    {
        Long rId = Long.valueOf(roleId);
        Long count = userRoleDao.getCountByUserRoleId(userId, rId);
        if (1 > count)
     ...
     * @return
     */
    public Page<PlatformRole> getRoleList(Map<String, Object> searchParams, int pageNumber, int pageSize)
    {
        PageRequest pageRequest = PageUtil.buildPageRequest(pageNumber, pageSize);
        Specification<PlatformRole> spec = PageUtil.buildSpecification(searchParams, PlatformRole.class);
    ...
    public List<String> findRoleButtonCodesByRoleId(Long roleId)
    {
        ...
        List<PlatformRoleButton> roleButtonList = roleButtonRelDao.findByRoleId(roleId);
