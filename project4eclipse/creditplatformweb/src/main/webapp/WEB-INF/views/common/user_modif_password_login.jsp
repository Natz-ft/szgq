...
<!--用户列表-->
<form action="common_modifPassword_login.do" method="post">
	...
	<table width="100%" align="center" cellpadding="2" cellspacing="2" class="td_title">
		<c:if test="${fn:length(errList) != 0}">
			...
			<td colspan="2" ><span style="color: red;">
				<c:forEach var="msg" items="${errList}">
					${msg}
				</c:forEach>
			</span></td>
		</tr>
		...
		<tr>
			...
			<td class="td_content" width="80%">
					<input name="loginNo" type="text" onblur="validateloginN(this)" value="${loginNo}" size="24" maxlength="50" readonly="readonly"/><span id="loginN" style="color: red"></span>
			</td>
		</tr>
		<tr>
