...
<div class="basepopopdiv popup357-381 base-wrap-s" id="create_dialog_id"  style="display: none;">
 		<div id="uploadModal" class="modal hide in" style="display:block;" aria-hidden="false">
			<div class="tiptop">
				<span>新建联系方式</span><a href="javascript:close_dialog1('create_dialog_id','create_form_id');"></a>
			</div>
			<div class="modal-body selectmodal wrap-s">
				<form method="post" action="insertContactus" id="create_form_id">
					 <table class="grayTable" id="ss1" data-prompt-position="topLeft">
						...
						<tr>
							...
							<td >
								<input type="text" name="hotline" class="validate[required] textinput"/><span class="star">*</span>
							</td>
						</tr>
						<tr>
							<th align="right" class="thStyle">邮编:</th>
							<td >
								<input type="text" name="zipCode" class="validate[required] textinput"/><span class="star">*</span>
							</td>
						</tr>
						<tr>
							<th align="right" class="thStyle">传真:</th>
							<td >
								<input type="text" name="fax" class="validate[required] textinput"/><span class="star">*</span>
							</td>
						</tr>
						<tr>
							<th align="right" class="thStyle">邮箱:</th>
							<td >
								<input type="text" name="mail" class="validate[required] textinput"/><span class="star">*</span>
							</td>
						</tr>
						<tr>
							<th align="right" class="thStyle">联系地址:</th>
							<td >
								<input type="text" name="adress" class="validate[required] textinput"/><span class="star">*</span>
							</td>
						</tr>
					</table>
				</form> 
