...
<div class="basepopopdiv popup357-381 base-wrap-s" id="create_dialog_id"  style="display: none;">
 		<div id="uploadModal" class="modal hide in" style="display:block;" aria-hidden="false">
			<div class="tiptop">
				<span>新建快捷菜单</span><a href="javascript:close_dialog('create_dialog_id');"></a>
			</div>
			<div class="modal-body selectmodal wrap-s">
				<form method="post" action="insertQuickMenu" id="create_form_id">
					 <table class="grayTable" id="ss1" data-prompt-position="topLeft">
						...
						<tr>
							<th align="right" class="thStyle">菜单路径:</th>
							<td >
								<input type="text" name="url" class="validate[required] textinput"/><span class="star">*</span>
							</td>
						</tr>
						<tr>
							<th align="right" class="thStyle">菜单logo</th>
							<td >
