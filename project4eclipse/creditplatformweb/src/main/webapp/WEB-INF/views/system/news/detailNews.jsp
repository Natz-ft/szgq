...
<!-- 	<div style="background:#EEF3F9 "> -->
    ...
    <div class="mainwraper" >
		...
		<div  style="display:none" id="infoId">123</div>
        <!--明细内容开始-->
        <div class="sub-c">
            <div class="pro-list">
                <h3>${news.title}</h3>
            ...
            <div style="margin-left:20px;margin-top:20px;">
                <div>${news.content}<div>
                  <c:if test='${news.newstype=="03"}'>
	                <c:if test="${not empty news.photo}">
	                 		 <p><b><a download="${news.uplodfileName}" style="cursor:pointer;"href="${news.photo}">${news.uplodfileName}</a></b></p>
	                </c:if>
                </c:if>
            </div>
