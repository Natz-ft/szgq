 ...
 $(function () {
   ...
   //监听审核按钮
     $("#uploadbtnListAction").on('click', function () {
         ...
         dataJson["faqtype"] ="0002";
    	 $.ajax({
             type: "post",
             async: false,
             url: "/creditplatformweb/faq/updateInform",
             data: {
...
<div class="boxWrap">
    <p class="boxTitle"><span>修改内容</span></p>
    <div class="formWrap">
            <div class="layui-form-item inputTitle">
                <label class="layui-form-label"><span class="star">*</span>通知：</label>
...
<!-- 左右两列左侧容器 -->
            ...
            <div class="layui-form-item">
                <label class="layui-form-label"><span class="star">*</span>通知内容：</label>
