...
<script type="text/javascript">
 ...
 <div class="basepopopdiv popup357-381 base-wrap-s" id="update_dialog_id"  >
	<div id="uploadModal" class="modal hide in" style="display:block;" aria-hidden="false">
		<div class="tiptop">
			<span>修改通知</span><a href="javascript:close_dialog('update_dialog_id');"></a>
		</div>
		<div class="modal-body selectmodal wrap-s">
			<form method="post" action="update" id="update_form_id">
				<!-- 不允许修改字段 -->
				<input type="hidden" name="id" value="${message.id }">
				<input type="hidden" name="createUser" value="${message.createUser }">
				<table class="grayTable" id="ss1" data-prompt-position="topLeft" >
						<tr>
							<th align="right" class="thStyle">通知标题:</th>
							<td><input type="text"  name="title"  value="${message.title }"  class="validate[required,length[1,128]] textinput"><span class="star">*</span></td>
						</tr>
					 	<%-- <tr>
						...
						<tr>
							...
							<td><textarea name="content" rows="8" cols="28" style="height:140px;" class="validate[required,length[1,4000]] textarea">${message.content }</textarea><span class="star">*</span></td>
						</tr> 
				 </table>
			 </form> 
		</div>
