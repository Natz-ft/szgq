...
<div class="tip" id="t2">
	...
	<div class="tipbtn">
		&nbsp;&nbsp;&nbsp; <input name="sure" type="button" class="btn-vip btn-pink" 
			value="确定" style="width: 60px;" onclick="delete_confirm_submit('id','/inverstorUser/delUser?id=');" /> &nbsp;&nbsp;&nbsp; <input
...
<!-- 重置密码确认框 -->
<div class="tip" id="t4" style="width:auto;min-width:350px">
	<div class="tiptop">
		<span>提示信息</span><a></a>
	</div>
	...
	<div class="tipbtn">
		&nbsp;&nbsp;&nbsp; <input name="sure" type="button" class="btn-vip btn-pink" 
			value="确定" style="width: 60px;" onclick="confirmReset();" /> &nbsp;&nbsp;&nbsp; <input
			name="cancel" type="button" style="width: 60px;" class="btn-vip btn-white" value="取消"
			onclick="fcancel()" />
	</div>
</div>
