...
<form action="curdFaq" id="list_form_id" method="post" name="list_form_name" onkeydown= "if(event.keycode==13)return   false;">  
	...
	<!-- 修改为自己查询页面的路径 -->
	<c:import url="/WEB-INF/views/system/faq/query_condition.jsp" />
</form>
...
function create_page() {
	layer.open({
	  	  ...
	  	  shade: 0,
	  	  area: ['70%', '85%'],
	  	  content: '/creditplatformweb/faq/createPage' //iframe的url
	  	}); 
...
function showDetail(id) {
	layer.open({
	  	  ...
	  	  shade: 0,
	  	  area: ['70%', '85%'],
	  	  content:  "/creditplatformweb/faq/detailFaq?id=" + id //iframe的url
	  	}); 
...
function updateDetail(id) {
	layer.open({
	  	  ...
	  	  shade: 0,
	  	  area: ['70%', '85%'],
	  	  content:  "/creditplatformweb/faq/updateFaq?id=" + id //iframe的url
	  	}); 
