...
<div class="basepopopdiv popup357-381 base-wrap-s" id="create_dialog_id"  style="display: none;">
 		<div id="uploadModal" class="modal hide in" style="display:block;" aria-hidden="false">
			...
			<div class="modal-body selectmodal wrap-s">
					 <form method="post" action="${ctx }/systemButton/create_systemButton.do" id="create_form_id">
					 <table class="grayTable" id="ss1" data-prompt-position="topLeft">
				<tr>
					<th align="right" class="thStyle">按钮名称:</th>
					<td >
					<input type="text" name="buttonName" class="validate[required]"/><span class="star">*</span>
					</td>
					</tr>
					<tr>
					<th align="right" class="thStyle">按钮代码:</th>
					<td><input type="text" name="buttonCode" class=" validate[required] " /><span class="star">*</span></td>
						</tr>
					<tr>
					<th align="right" class="thStyle">按钮描述:</th>
					<td >
					<textarea rows="4" cols="28" name="buttonDesc"  class="validate[required] textarea" maxlength="200"></textarea><span class="star">*</span>
					</td>
				</tr>
			</table>
				</form> 
			...
			<div class="modal-footer">
				<button type="submit" class="btn-vip btn-pink"    id="createBtn" onclick="create_submit('create_form_id','create_dialog_id');">确定</button>
