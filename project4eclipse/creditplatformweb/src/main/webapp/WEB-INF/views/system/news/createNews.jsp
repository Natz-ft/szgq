...
<div class="boxWrap">
    <p class="boxTitle"><span>新增内容</span></p>
    <div class="formWrap">
            <div class="layui-form-item inputTitle">
                ...
                <div class="layui-input-block" style="padding: 5px 0px;">
                    <input type="text" id="titleId" name="title"  autocomplete="off" class="layui-input">
                </div>
            </div>
            <!-- 左右两列左侧容器 -->
             <div class="layui-form-item">
                ...
                <div class="termsList" id="newstype" style="margin-left:-5px;margin-top:4px;">
                    <ul class="clearfix" id="statusType">
 						<c:forEach var="news" items="${statusList}">
				            <li><a value="${news.dicCode}">${news.dicName} </a></li>
						</c:forEach>
					</ul>
                </div>
            </div>
            ...
            <!-- 新闻日期 -->
             <div class="layui-form-item">
                ...
                <div class="layui-input-block" style="padding: 5px 0px;">
                    <input type="text" id="newsDate"  class="layui-input" name="newsDate"  onfocus=" WdatePicker({dateFmt:'yyyy-MM-dd'})"  value="" onkeydown="if(event.keyCode==13){event.keyCode=0;return false}" />
                </div>
            </div>
            <!-- 是否轮播 -->
             <div class="layui-form-item">
                ...
                <div class="layui-input-block" id="isLunbo" style="padding: 12px 0px;">
                    <input type="radio" name="isLunbo" value="1"/>
                    <label> 是</label>&nbsp;&nbsp;&nbsp;
                    <input type="radio" name="isLunbo" value="0" checked/>
                    <label> 否</label>　
                </div>
            </div>
            <!-- 轮播顺序 -->
             <div class="layui-form-item">
                ...
                <div class="layui-input-block" style="padding: 5px 0px;">
                    <input type="text" id="lunboOrd" name="lunboOrd"  autocomplete="off" class="layui-input" readonly>
                </div>
            </div>
            ...
            <div class="layui-form-item">
                <label class="layui-form-label"><span class="star" id="pictureId"></span>新增图片：</label>
   ...
   //监听审核按钮
     $("#uploadbtnListAction").on('click', function () {
    	 ...
    	 $.ajax({
             type: "post",
             async: false,
             url: "/creditplatformweb/news/insertNews",
             data: {
