		...
		<div action="" id="queryFormId">
		    <div class="modal-body selectmodal wrap-xs" >
				<table class="grayTable" data-prompt-position="topLeft">
					<tbody>
						<tr>
							<th  align="right" class="thStyle"><span>字典类型:</span></th> 
								<td>
						<select id="type" name="search_LIKE_type" class="validate[required] wrap-select">
						...
						<tr>
							<th align="right" class="thStyle"><span>字典数值:</span></th> 
							<td>
								<input type="text" name="search_LIKE_name" value="${page.paramsMap.search_LIKE_name }" onkeydown="if(event.keyCode==13){event.keyCode=0;return false}" />
							</td>
						</tr>
					</tbody>					
				</table>
