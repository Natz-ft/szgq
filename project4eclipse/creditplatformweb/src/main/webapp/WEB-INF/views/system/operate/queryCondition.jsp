				...
				<table class="grayTable" data-prompt-position="topLeft">
					<tbody>
						...
						<tr>
							...
							<td>
								<select name="search_EQ_exeResult" class="wrap-select">
									<option value=""  selected="selected">请选择</option>
									<c:forEach var="status" items="${sessionScope.statusList2}">
				       ...
				       <tr>
							...
							<td>
							<input type="text" style="width:140px;" name="search_GTE_startTime_DATE"  onfocus=" WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" value="${GTE_startTime}" onkeydown="if(event.keyCode==13){event.keyCode=0;return false}" /> 至 
							<input type="text" style="width:140px;" name="search_LTE_startTime_DATE"  onfocus=" WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"  value="${LTE_startTime}" onkeydown="if(event.keyCode==13){event.keyCode=0;return false}" /> 
							</td>
						</tr> 
						<%-- <tr>
