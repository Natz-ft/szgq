				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
					    <input type="text" id="projectName" name="projectName" autocomplete="off"
							class="layui-input" value="${finacingEvent['projectName']}">
						<input type="hidden" id="eventId" name="eventId" autocomplete="off"
							class="layui-input" value="${finacingEvent['eventId']}">
					</div>
				</div>
		...
		$("#upProjectName").on(
				...
				function() {
					...
					$.ajax({
						type : "post",
						async : false,
						url : "/creditplatformweb/event/subProjectName",
						data : {
