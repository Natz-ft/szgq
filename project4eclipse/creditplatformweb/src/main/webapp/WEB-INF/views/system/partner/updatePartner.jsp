...
<div class="boxWrap">
    <p class="boxTitle"><span>编辑合作伙伴</span></p>
    <div class="formWrap">
            <div class="layui-form-item inputTitle">
                ...
                <div class="layui-input-block" style="padding: 5px 0px;">
                    <input type="text" id="name" name="name" value="${partner.name}"  autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item inputTitle">
                <label class="layui-form-label"><span class="star">*</span>链接地址：</label>
                <div class="layui-input-block" style="padding: 5px 0px;">
                    <input type="text" id="link" name="link" value="${partner.link}"  autocomplete="off" class="layui-input">
                </div>
            </div>
<!-- 左右两列左侧容器 -->
                <div class="layui-form-item">
                 <label class="layui-form-label">合作伙伴logo：</label>
