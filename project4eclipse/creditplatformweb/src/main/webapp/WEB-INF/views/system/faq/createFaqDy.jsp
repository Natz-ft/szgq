...
<div class="boxWrap">
    <p class="boxTitle"><span>新增通知</span></p>
    <div class="formWrap">
            ...
            <!-- 日期 -->
             <div class="layui-form-item">
                ...
                <div class="layui-input-block" style="padding: 5px 0px;">
                    <input type="text" id="faqDate"  class="layui-input" name="faqDate"  onfocus=" WdatePicker({dateFmt:'yyyy-MM-dd'})"  value="" onkeydown="if(event.keyCode==13){event.keyCode=0;return false}" />
                </div>
            </div>
            <div class="layui-form-item">
            ...
            <div class="layui-form-item">
             ...
             <div class="layui-form-item inputTitle">
                ...
                <div class="layui-input-block"  style="padding: 5px 0px;">
                      <input type="text" id="indexTitle" name="indexTitle" placeholder="请输入"  autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item inputTitle">
                <label class="layui-form-label"><span class="star">*</span>首页副标题：</label>
                <div class="layui-input-block"  style="padding: 5px 0px;">
                      <input type="text" id="indexSubTitle" name="indexSubTitle" placeholder="请输入"  autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
        ...
        var index = layedit.build('demandDetails');
	     ...
	     $("#uploadbtnListAction").on('click', function () {
	    	 ...
	    	 $.ajax({
	             type: "post",
	             async: false,
	             url: "/creditplatformweb/faq/insertFaqDy",
	             data: {
